...
This code is used to create, train, validate and test the <METEO> model variant from 
...
# ----- meteo static feature experiment  ----------


# Import dataset to use
from camelsus_sumstat_2 import CAMELS_US
...
for seedi in seeds: 
    ...
    experiment_name = "sumstat2_"+str(seedi)
    
    # paths to access the information
    path_entities = pth0+"data/CAMELS_US/basins_camels_us_531.txt"
    path_entities_test = pth0+"data/CAMELS_US/basins_camels_us_531.txt"
